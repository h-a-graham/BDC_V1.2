...
def exports_main(exp_f):
    ...
    BHI_gdb = os.path.join(export_fold, "BHI_5m.gdb")
    ...
    BVI_gdb = os.path.join(export_fold, "BVI_5m.gdb")
    ...
    collect_HR_data(exp_f, BHI_exten, BHI_gdb)
    collect_HR_data(exp_f, BVI_exten, BVI_gdb)

def collect_HR_data(exp_f, exten, file_gdb):
    ...
    for file in rasters:
        ...
        try:
            arcpy.CopyRaster_management(file, outName)
